...
trunk_id = "ST_yPzqQFHC9V6V"
dispatch_payload = {
    "name": "InboundMedicalDispatchRule",
    "trunk_ids": [trunk_id],
    "rule": {
        "dispatchRuleIndividual": {  # tạo room riêng cho mỗi caller
            "roomPrefix": "inbound-"  # mỗi room sẽ có tên inbound-xxxx
        }
    },
    "room_config": {
        "agents": [
