...
dispatch_payload = {
    ...
    "rule": {
        "dispatchRuleIndividual": {
            "roomPrefix": "phong-dang-ky-"  # Không dùng prefix, dùng tên phòng cố định
        },
        "dispatchRuleRooms": ["PhongDangKy01", "PhongDangKy02"]  # Dispatch trực tiếp vào 2 phòng này
    },
    "room_config": {
        "agents": [],  # Không cần chỉ định agent, LiveKit sẽ tạo participant mặc định
    }
}
